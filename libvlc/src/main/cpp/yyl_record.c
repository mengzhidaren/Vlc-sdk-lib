...
Java_com_vlc_lib_RecordEvent_startRecord__Lorg_videolan_libvlc_MediaPlayer_2Ljava_lang_String_2Ljava_lang_String_2(
        JNIEnv *env, jobject instance, jobject mediaPlayer, jstring fileDirectory_,
        jstring fileName_) {
...
JNIEXPORT jboolean JNICALL
Java_com_vlc_lib_RecordEvent_stopRecord(JNIEnv *env, jobject instance, jobject mediaPlayer) {
...
JNIEXPORT jboolean JNICALL
Java_com_vlc_lib_RecordEvent_isRecording(JNIEnv *env, jobject instance, jobject mediaPlayer) {
    bool b_record = false;
    input_thread_t *input_thread = getInputThread(env, mediaPlayer);
    if (input_thread) {
...
JNIEXPORT jboolean JNICALL
Java_com_vlc_lib_RecordEvent_isSuportRecord(JNIEnv *env, jobject instance, jobject mediaPlayer) {
...
Java_com_vlc_lib_RecordEvent_takeSnapshot(JNIEnv *env, jobject instance, jobject mediaPlayer,
